...
/* =========================================================
   Complete permission matrix and action-level enforcement
   - Permissions live in Settings > الصلاحيات والأمان only.
   - User management stays light.
   - Every visible section, dashboard card, shortcut and sensitive action is linked to a permission.
   ========================================================= */
(function completePermissionMatrixPatch(){
  const FULL_PERMISSION_GROUPS = [
    { id: 'dashboard', title: 'الصفحة الرئيسية', items: [
      ['dashboard.view', 'عرض الصفحة الرئيسية'],
      ['dashboard.stats', 'عرض بطاقات الإحصائيات العلوية'],
      ['dashboard.cardEmployees', 'عرض بطاقة إجمالي الموظفين'],
      ['dashboard.cardAttendance', 'عرض بطاقة الحاضرون اليوم'],
      ['dashboard.cardLeaves', 'عرض بطاقة طلبات الإجازة'],
      ['dashboard.cardPayroll', 'عرض بطاقة رواتب هذا الشهر'],
      ['dashboard.travelers', 'عرض بطاقة المسافرون'],
      ['dashboard.travelersOwn', 'عرض المسافرين الخاصين بالمستخدم فقط'],
      ['dashboard.travelersAll', 'عرض جميع المسافرين'],
      ['dashboard.reviewRequests', 'عرض بطاقة طلبات تحتاج مراجعة'],
      ['dashboard.reviewOwn', 'عرض طلباتي فقط في الرئيسية'],
      ['dashboard.reviewAll', 'عرض طلبات جميع الموظفين في الرئيسية'],
      ['dashboard.reviewViewDetails', 'فتح تفاصيل الطلب من زر العين'],
      ['dashboard.reviewActions', 'الموافقة والرفض من الصفحة الرئيسية'],
      ['dashboard.expiringDocs', 'عرض الوثائق التي شارفت على الانتهاء'],
      ['dashboard.expiringDocsOwn', 'عرض وثائق الموظف نفسه فقط'],
      ['dashboard.expiringDocsAll', 'عرض وثائق جميع الموظفين'],
      ['dashboard.reviewShortcut', 'عرض زر مراجعة الطلبات'],
      ['dashboard.absenceShortcut', 'عرض زر تسجيل الغياب'],
      ['dashboard.recentEmployees', 'عرض أحدث الموظفين']
    ]},
    { id: 'employees', title: 'الموظفون', items: [
      ['employees.viewSection', 'عرض قسم الموظفين'],
      ['employees.viewSelf', 'عرض ملفه فقط'],
      ['employees.viewAll', 'عرض جميع الموظفين'],
      ['employees.create', 'إضافة موظف'],
      ['employees.editSelf', 'تعديل ملفه فقط'],
      ['employees.edit', 'تعديل جميع الموظفين'],
      ['employees.delete', 'حذف الموظفين'],
      ['employees.changeStatus', 'تغيير حالة الموظف'],
      ['employees.attachmentsView', 'عرض مرفقات الموظفين'],
      ['employees.attachmentsUpload', 'رفع مرفقات للموظف'],
      ['employees.attachmentsDelete', 'حذف مرفقات الموظف'],
      ['employees.personalDocsView', 'عرض الوثائق الشخصية للموظف'],
      ['employees.personalDocsEdit', 'تعديل الإقامة / الهوية / الجواز'],
      ['employees.notes', 'إضافة أو تعديل ملاحظات ومحاضر الموظف'],
      ['employees.export', 'تصدير قائمة الموظفين']
    ]},
    { id: 'attendance', title: 'الحضور والانصراف', items: [
      ['attendance.viewSection', 'عرض قسم الحضور والانصراف'],
      ['attendance.viewSelf', 'عرض حضور الموظف نفسه'],
      ['attendance.viewAll', 'عرض حضور جميع الموظفين'],
      ['attendance.markSelf', 'تسجيل حضور أو انصراف لنفسه'],
      ['attendance.registerAbsence', 'تسجيل غياب'],
      ['attendance.registerAbsenceOthers', 'تسجيل غياب لموظف آخر'],
      ['attendance.edit', 'تعديل سجلات الحضور'],
      ['attendance.deleteAbsence', 'حذف سجل غياب'],
      ['attendance.reports', 'عرض تقارير الحضور'],
      ['attendance.export', 'تصدير تقرير الحضور']
    ]},
    { id: 'leaves', title: 'الإجازات والسفر', items: [
      ['leaves.viewSection', 'عرض قسم الإجازات والسفر'],
      ['leaves.viewOwn', 'عرض طلباته فقط'],
      ['leaves.viewAll', 'عرض طلبات الجميع'],
      ['leaves.createLeave', 'إنشاء طلب إجازة'],
      ['leaves.createTravel', 'إنشاء طلب سفر'],
      ['leaves.editOwnPending', 'تعديل طلبي قبل الاعتماد'],
      ['leaves.deleteOwnPending', 'حذف طلبي قبل الاعتماد'],
      ['leaves.approveLeave', 'الموافقة على طلب إجازة'],
      ['leaves.rejectLeave', 'رفض طلب إجازة'],
      ['leaves.approveTravel', 'الموافقة على طلب سفر'],
      ['leaves.rejectTravel', 'رفض طلب سفر'],
      ['leaves.resume', 'تسجيل المباشرة بعد العودة'],
      ['leaves.viewTravelers', 'عرض قائمة المسافرين'],
      ['leaves.viewTravelersOwn', 'عرض المسافرين الخاصين بي فقط'],
      ['leaves.viewTravelersAll', 'عرض جميع المسافرين'],
      ['leaves.viewDetails', 'فتح تفاصيل الطلب'],
      ['leaves.print', 'طباعة أو تصدير الطلبات']
    ]},
    { id: 'payroll', title: 'الرواتب والعمولات', items: [
      ['payroll.viewSection', 'عرض قسم الرواتب والعمولات'],
      ['payroll.viewSelf', 'عرض راتبي فقط'],
      ['payroll.viewAll', 'عرض رواتب جميع الموظفين'],
      ['payroll.create', 'إضافة راتب'],
      ['payroll.edit', 'تعديل الرواتب'],
      ['payroll.delete', 'حذف راتب'],
      ['payroll.approve', 'اعتماد وصرف الرواتب'],
      ['payroll.commissionsView', 'عرض العمولات'],
      ['payroll.commissionsCreate', 'إضافة عمولة'],
      ['payroll.commissionsEdit', 'تعديل عمولة'],
      ['payroll.commissionsDelete', 'حذف عمولة'],
      ['payroll.printClearance', 'طباعة المخالصة'],
      ['payroll.clearanceHistory', 'عرض سجل المخالصات'],
      ['payroll.export', 'تصدير الرواتب']
    ]},
    { id: 'documents', title: 'وثائق المنشأة', items: [
      ['documents.viewSection', 'عرض قسم وثائق المنشأة'],
      ['documents.view', 'عرض الوثائق'],
      ['documents.create', 'إضافة وثيقة'],
      ['documents.edit', 'تعديل وثيقة'],
      ['documents.delete', 'حذف وثيقة'],
      ['documents.upload', 'رفع مرفق وثيقة'],
      ['documents.deleteAttachment', 'حذف مرفق وثيقة'],
      ['documents.expiryAlerts', 'عرض تنبيهات وثائق المنشأة قرب الانتهاء']
    ]},
    { id: 'departments', title: 'الأقسام والإدارات', items: [
      ['departments.viewSection', 'عرض قسم الأقسام والإدارات'],
      ['departments.addDepartment', 'إضافة إدارة'],
      ['departments.editDepartment', 'تعديل إدارة'],
      ['departments.deleteDepartment', 'حذف إدارة'],
      ['departments.addSection', 'إضافة قسم'],
      ['departments.editSection', 'تعديل قسم'],
      ['departments.deleteSection', 'حذف قسم'],
      ['departments.addJob', 'إضافة مهنة'],
      ['departments.editJob', 'تعديل مهنة'],
      ['departments.deleteJob', 'حذف مهنة'],
      ['departments.assignManagers', 'تعيين مدير إدارة أو قسم']
    ]},
    { id: 'settings', title: 'الإعدادات', items: [
      ['settings.view', 'عرض الإعدادات'],
      ['settings.company', 'تعديل بيانات المنشأة'],
      ['settings.system', 'تعديل إعدادات النظام'],
      ['settings.work', 'إعداد أيام وساعات العمل'],
      ['settings.absencePolicy', 'إعداد قاعدة بيانات الغياب'],
      ['settings.minutes', 'إعداد المحاضر والقوالب'],
      ['settings.lists', 'تعديل القوائم الأساسية'],
      ['settings.permissionsSecurity', 'الوصول إلى الصلاحيات والأمان']
    ]},
    { id: 'users', title: 'إدارة المستخدمين', items: [
      ['users.viewSection', 'عرض إدارة المستخدمين'],
      ['users.create', 'إضافة مستخدم'],
      ['users.edit', 'تعديل مستخدم'],
      ['users.delete', 'حذف مستخدم'],
      ['users.disable', 'إيقاف مستخدم'],
      ['users.enable', 'تنشيط مستخدم'],
      ['users.resetPassword', 'إعادة تعيين كلمة مرور'],
      ['users.changeRole', 'تغيير نوع الحساب مدير نظام / موظف']
    ]}
  ];
  const FULL_PERMISSION_KEYS = FULL_PERMISSION_GROUPS.flatMap(group => group.items.map(item => item[0]));
  const FULL_DEFAULT_EMPLOYEE_PERMISSIONS = Object.fromEntries(FULL_PERMISSION_KEYS.map(key => [key, false]));
  Object.assign(FULL_DEFAULT_EMPLOYEE_PERMISSIONS, {
    'dashboard.view': true,
    'dashboard.stats': true,
    'dashboard.cardLeaves': true,
    'dashboard.reviewOwn': true,
    'employees.viewSection': true,
    'employees.viewSelf': true,
    'attendance.viewSection': true,
    'attendance.viewSelf': true,
    'leaves.viewSection': true,
    'leaves.viewOwn': true,
    'leaves.createLeave': true,
    'leaves.createTravel': true
  });
  function roleIsAdmin(){ return String(authProfile?.role || '').toLowerCase() === 'admin'; }
  function normalizedRole(role){ return String(role || 'employee') === 'admin' ? 'admin' : 'employee'; }
  function normalizeFullPermissions(raw, role){
    if (normalizedRole(role) === 'admin') return Object.fromEntries(FULL_PERMISSION_KEYS.map(key => [key, true]));
    const source = raw && typeof raw === 'object' && !Array.isArray(raw) ? raw : {};
    const out = { ...FULL_DEFAULT_EMPLOYEE_PERMISSIONS };
    const legacyAliases = {
      'dashboard.reviewActions': ['dashboard.reviewActions'],
      'leaves.approve': ['leaves.approveLeave','leaves.approveTravel'],
      'leaves.reject': ['leaves.rejectLeave','leaves.rejectTravel'],
      'payroll.view': ['payroll.viewSection','payroll.viewAll'],
      'payroll.commissions': ['payroll.commissionsView'],
      'documents.view': ['documents.viewSection','documents.view'],
      'employees.attachments': ['employees.attachmentsView','employees.attachmentsUpload']
    };
    FULL_PERMISSION_KEYS.forEach(key => { if (Object.prototype.hasOwnProperty.call(source, key)) out[key] = Boolean(source[key]); });
    Object.entries(legacyAliases).forEach(([oldKey, newKeys]) => {
      if (Object.prototype.hasOwnProperty.call(source, oldKey)) newKeys.forEach(key => out[key] = Boolean(source[oldKey]));
    });
    return out;
  }
  function canFull(key){
    if (roleIsAdmin()) return true;
    return Boolean(normalizeFullPermissions(authProfile?.permissions, authProfile?.role)[key]);
  }
  function canAny(keys){ return keys.some(canFull); }
  function myEmployee(){
    const email = String(authUser?.email || authProfile?.email || '').trim().toLowerCase();
    return (Array.isArray(employees) ? employees : []).find(emp => String(emp.email || '').trim().toLowerCase() === email) || null;
  }
  function ownsEmployee(employeeId){ const mine = myEmployee(); return Boolean(mine && String(mine.id) === String(employeeId)); }
  function canSeeEmployee(employeeId){ return roleIsAdmin() || canFull('employees.viewAll') || ownsEmployee(employeeId); }
  function canSeeLeave(leave){ return roleIsAdmin() || canFull('leaves.viewAll') || ownsEmployee(leave?.employeeId); }
  function canSeeTravel(travel){ return roleIsAdmin() || canFull('leaves.viewTravelersAll') || canFull('dashboard.travelersAll') || ownsEmployee(travel?.employeeId); }
  function deny(message='ليست لديك صلاحية لهذا الإجراء') { if (typeof showToast === 'function') showToast(message); }
  window.alfarihPermissions = { groups: FULL_PERMISSION_GROUPS, keys: FULL_PERMISSION_KEYS, defaults: FULL_DEFAULT_EMPLOYEE_PERMISSIONS, can: canFull, normalize: normalizeFullPermissions };
  window.cleanEmployeePermissions = window.alfarihPermissions;

  currentRoleKey = function(){ return normalizedRole(authProfile?.role); };
  roleOptions = function(selected = 'employee'){
    const role = normalizedRole(selected);
    return `<option value="admin" ${role === 'admin' ? 'selected' : ''}>مدير النظام</option><option value="employee" ${role === 'employee' ? 'selected' : ''}>موظف</option>`;
  };
  roleBadge = function(role){ return `<span class="status-badge status-approved">${normalizedRole(role) === 'admin' ? 'مدير النظام' : 'موظف'}</span>`; };
  roleCanOpen = function(viewName){
    if (roleIsAdmin()) return true;
    const map = {
      dashboard: canFull('dashboard.view'),
      employees: canAny(['employees.viewSection','employees.viewSelf','employees.viewAll']),
      attendance: canAny(['attendance.viewSection','attendance.viewSelf','attendance.viewAll','attendance.registerAbsence']),
      leaves: canAny(['leaves.viewSection','leaves.viewOwn','leaves.viewAll','leaves.createLeave','leaves.createTravel','leaves.viewTravelers']),
      payroll: canAny(['payroll.viewSection','payroll.viewSelf','payroll.viewAll','payroll.commissionsView']),
      departments: canAny(['departments.viewSection','departments.addDepartment','departments.addSection','departments.addJob']),
      settings: canAny(['settings.view','settings.company','settings.work','settings.absencePolicy','settings.minutes','settings.permissionsSecurity']),
      users: canAny(['users.viewSection','users.create','users.edit','users.delete','users.disable','users.enable'])
    };
    return Boolean(map[viewName]);
  };

  const oldLoadAuthProfileFull = loadAuthProfile;
  loadAuthProfile = async function(user){
    const profile = await oldLoadAuthProfileFull(user);
    if (profile) profile.permissions = normalizeFullPermissions(profile.permissions, profile.role);
    return profile;
  };

  function edgeManageUsersFull(body){
    if (!supabaseClient) return Promise.reject(new Error('Supabase غير متصل'));
    return supabaseClient.functions.invoke('admin-create-user', { body });
  }
  loadAppUserProfiles = async function(){
    if (!roleIsAdmin() && !canFull('settings.permissionsSecurity') && !canFull('users.viewSection')) return [];
    const { data, error } = await edgeManageUsersFull({ action: 'list-users' });
    if (error) throw error;
    if (data?.error) throw new Error(data.error);
    appUserProfilesCache = Array.isArray(data?.users) ? data.users.map(p => ({ ...p, role: normalizedRole(p.role), permissions: normalizeFullPermissions(p.permissions, p.role) })) : [];
    return appUserProfilesCache;
  };
  const oldSaveUserProfileFromFormFull = saveUserProfileFromForm;
  saveUserProfileFromForm = async function(form){
    if (!roleIsAdmin() && !canFull('users.create') && !canFull('users.edit')) return deny('إدارة المستخدمين غير مسموحة');
    const profileId = form.elements.profileId.value.trim();
    if (profileId && !canFull('users.edit')) return deny('لا تملك صلاحية تعديل المستخدمين');
    if (!profileId && !canFull('users.create')) return deny('لا تملك صلاحية إضافة مستخدم');
    const existing = appUserProfilesCache.find(p => p.id === profileId);
    const role = normalizedRole(form.elements.role.value);
    if (role === 'admin' && !roleIsAdmin() && !canFull('users.changeRole')) return deny('تغيير نوع الحساب غير مسموح');
    const payload = {
      id: profileId,
      email: form.elements.email.value.trim().toLowerCase(),
      fullName: form.elements.fullName.value.trim(),
      role,
      isActive: form.elements.isActive.value === 'true',
      permissions: profileId ? normalizeFullPermissions(existing?.permissions, role) : normalizeFullPermissions({}, role)
    };
    const password = form.elements.password?.value || '';
    if (!payload.fullName || !payload.email) return deny('أدخل الاسم والبريد');
    if (!profileId && password.length < 6) return deny('كلمة المرور يجب أن تكون 6 أحرف على الأقل');
    try {
      const body = profileId ? { action: 'update-user', ...payload } : { action: 'create-user', ...payload, password };
      const { data, error } = await edgeManageUsersFull(body);
      if (error) throw error;
      if (data?.error) throw new Error(data.error);
      if (typeof resetUserProfileForm === 'function') resetUserProfileForm();
      document.querySelector('#userProfileModal')?.close();
      await renderUsersManagement();
      showToast(profileId ? 'تم تحديث المستخدم' : 'تم إنشاء المستخدم');
    } catch (error) { console.error(error); showToast(String(error?.message || 'تعذر حفظ المستخدم').slice(0, 160)); }
  };
  toggleUserProfile = async function(id){
    const profile = appUserProfilesCache.find(p => p.id === id);
    if (!profile) return;
    if (authProfile?.id === profile.id && profile.is_active) return deny('لا يمكنك إيقاف حسابك الحالي');
    if (profile.is_active && !canFull('users.disable')) return deny('لا تملك صلاحية إيقاف المستخدم');
    if (!profile.is_active && !canFull('users.enable')) return deny('لا تملك صلاحية تنشيط المستخدم');
    try {
      const { data, error } = await edgeManageUsersFull({ action: 'toggle-user', id, isActive: !profile.is_active });
      if (error) throw error;
      if (data?.error) throw new Error(data.error);
      await renderUsersManagement();
      showToast(profile.is_active ? 'تم إيقاف المستخدم' : 'تم تنشيط المستخدم');
  ...
  deleteUserProfile = async function(id){
    if (!canFull('users.delete')) return deny('لا تملك صلاحية حذف المستخدم');
    const profile = appUserProfilesCache.find(p => p.id === id);
    if (!profile) return;
    if (authProfile?.id === profile.id) return deny('لا يمكنك حذف حسابك الحالي');
    if (!confirm(`هل تريد حذف المستخدم ${profile.full_name || profile.email} نهائيًا؟`)) return;
    try {
      const { data, error } = await edgeManageUsersFull({ action: 'delete-user', id, user_id: profile.user_id, email: profile.email });
      if (error) throw error;
      if (data?.error) throw new Error(data.error);
      await renderUsersManagement();
      showToast('تم حذف المستخدم');
  ...
  function permissionsEditorFullHtml(permissions){
    const normalized = normalizeFullPermissions(permissions, 'employee');
    return `<div class="security-permissions-toolbar"><button type="button" class="secondary-btn" id="selectCommonEmployeePerms">صلاحيات موظف عادي</button><button type="button" class="secondary-btn" id="clearAllEmployeePerms">إلغاء الكل</button></div><div class="security-permissions-grid full-permissions-grid">${FULL_PERMISSION_GROUPS.map(group => `
      <section class="security-permission-card">
        <div class="security-permission-head"><strong>${escapeHtml(group.title)}</strong><button type="button" class="text-btn" data-security-full-group="${escapeHtml(group.id)}">تحديد الكل</button></div>
        <div class="security-permission-list">
          ${group.items.map(([key, label]) => `<label class="security-permission-row"><span>${escapeHtml(label)}</span><input type="checkbox" data-security-full-permission="${escapeHtml(key)}" ${normalized[key] ? 'checked' : ''}></label>`).join('')}
        </div>
      </section>`).join('')}</div>`;
  }
  function ensurePermissionsSecurityPanelFull(){
    const panel = document.querySelector('[data-settings-panel="permissions"]');
    if (!panel) return;
    panel.innerHTML = `
      <div class="panel-head"><div><h3>الصلاحيات والأمان</h3><p>حدد صلاحيات الموظف على مستوى الصفحة، البطاقة، الزر، الجدول، ونوع البيانات التي تظهر له.</p></div></div>
      <div class="security-layout">
        <article class="settings-placeholder-card security-user-picker"><span data-icon="shield"></span><div><strong>تحديد المستخدم</strong><p>مدير النظام يملك كل الصلاحيات تلقائيًا. هذه الصفحة لضبط صلاحيات حسابات الموظفين فقط.</p></div></article>
        <div class="security-controls"><select id="securityUserSelectFull"><option value="">اختر مستخدمًا...</option></select><button type="button" class="secondary-btn" id="reloadSecurityUsersFull"><span data-icon="refresh"></span>تحديث المستخدمين</button><button type="button" class="primary-btn" id="saveSecurityPermissionsFull"><span data-icon="check"></span>حفظ الصلاحيات</button></div>
        <div id="securityPermissionsEditorFull" class="security-editor-empty"><strong>اختر مستخدمًا من القائمة</strong><p>بعد الاختيار ستظهر كل صلاحيات النظام مقسمة حسب الأقسام.</p></div>
      </div>`;
    if (!document.querySelector('#completePermissionStyles')) {
      const style = document.createElement('style');
      style.id = 'completePermissionStyles';
      style.textContent = `.is-permission-hidden{display:none!important}.security-permissions-toolbar{display:flex;gap:10px;flex-wrap:wrap;margin-bottom:12px}.full-permissions-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.security-permission-card{min-height:auto}.security-permission-row span{line-height:1.55}@media(max-width:900px){.full-permissions-grid{grid-template-columns:1fr}}`;
      document.head.appendChild(style);
    }
    if (typeof hydrateIcons === 'function') hydrateIcons(panel);
  }
  async function loadSecurityUsersFull(){
    const select = document.querySelector('#securityUserSelectFull');
    if (!select) return;
    select.innerHTML = `<option value="">جاري تحميل المستخدمين...</option>`;
    try {
      await loadAppUserProfiles();
      const employeesOnly = appUserProfilesCache.filter(p => normalizedRole(p.role) !== 'admin');
      select.innerHTML = `<option value="">اختر مستخدمًا...</option>` + employeesOnly.map(p => `<option value="${escapeHtml(p.id)}">${escapeHtml(p.full_name || p.email)} - ${escapeHtml(p.email || '')}</option>`).join('');
      if (!employeesOnly.length) select.innerHTML = `<option value="">لا يوجد موظفون</option>`;
    } catch (error) { console.error(error); select.innerHTML = `<option value="">تعذر تحميل المستخدمين</option>`; showToast('تعذر تحميل مستخدمي الصلاحيات'); }
  }
  function renderSelectedSecurityUserFull(){
    const id = document.querySelector('#securityUserSelectFull')?.value;
    const editor = document.querySelector('#securityPermissionsEditorFull');
    const profile = appUserProfilesCache.find(p => p.id === id);
    if (!editor) return;
    if (!profile) { editor.className = 'security-editor-empty'; editor.innerHTML = `<strong>اختر مستخدمًا من القائمة</strong><p>بعد الاختيار ستظهر الصلاحيات.</p>`; return; }
    editor.className = '';
    editor.innerHTML = permissionsEditorFullHtml(profile.permissions);
  }
  async function saveSelectedSecurityPermissionsFull(){
    const id = document.querySelector('#securityUserSelectFull')?.value;
    const profile = appUserProfilesCache.find(p => p.id === id);
    if (!profile) return deny('اختر مستخدمًا أولًا');
    const permissions = {};
    FULL_PERMISSION_KEYS.forEach(key => { permissions[key] = Boolean(document.querySelector(`[data-security-full-permission="${CSS.escape(key)}"]`)?.checked); });
    try {
      const { data, error } = await edgeManageUsersFull({ action: 'update-user', id: profile.id, email: profile.email, fullName: profile.full_name, role: 'employee', isActive: profile.is_active, permissions });
      if (error) throw error;
      if (data?.error) throw new Error(data.error);
      profile.permissions = normalizeFullPermissions(permissions, 'employee');
      showToast('تم حفظ صلاحيات الموظف');
    } catch (error) { console.error(error); showToast('تعذر حفظ الصلاحيات'); }
  }
  const oldRenderPermissionsPreviewFull = renderPermissionsPreview;
  renderPermissionsPreview = function(){ ensurePermissionsSecurityPanelFull(); };
  const oldSwitchSettingsSectionFull = switchSettingsSection;
  switchSettingsSection = function(section){
    oldSwitchSettingsSectionFull(section);
    if (section === 'permissions') { ensurePermissionsSecurityPanelFull(); loadSecurityUsersFull(); }
    applyRolePermissions();
  };
  document.addEventListener('click', (event) => {
    if (event.target.closest('#reloadSecurityUsersFull')) loadSecurityUsersFull();
    if (event.target.closest('#saveSecurityPermissionsFull')) saveSelectedSecurityPermissionsFull();
    const groupBtn = event.target.closest('[data-security-full-group]');
    if (groupBtn) {
      const card = groupBtn.closest('.security-permission-card');
      const boxes = [...card.querySelectorAll('[data-security-full-permission]')];
      const shouldCheck = boxes.some(box => !box.checked);
      boxes.forEach(box => box.checked = shouldCheck);
    }
    if (event.target.closest('#clearAllEmployeePerms')) document.querySelectorAll('[data-security-full-permission]').forEach(box => box.checked = false);
    if (event.target.closest('#selectCommonEmployeePerms')) {
      const defaults = normalizeFullPermissions({}, 'employee');
      document.querySelectorAll('[data-security-full-permission]').forEach(box => { box.checked = Boolean(defaults[box.dataset.securityFullPermission]); });
    }
  });
  document.addEventListener('change', (event) => { if (event.target?.id === 'securityUserSelectFull') renderSelectedSecurityUserFull(); });

  function hideBySelector(selector, hide){ document.querySelectorAll(selector).forEach(el => el.classList.toggle('is-permission-hidden', Boolean(hide))); }
  function hideButtonByPermission(selector, permission){ hideBySelector(selector, !canFull(permission)); }
  function applyButtonPermissions(){
    if (roleIsAdmin()) return;
    hideButtonByPermission('#quickAddBtn, .add-employee-btn, [data-open-employee-modal="new"]', 'employees.create');
    hideButtonByPermission('#exportBtn', 'employees.export');
    hideButtonByPermission('#newAbsenceBtn, #dashboardAbsenceBtn', 'attendance.registerAbsence');
    hideButtonByPermission('#attendanceExportBtn', 'attendance.export');
    hideButtonByPermission('#newLeaveBtn', 'leaves.createLeave');
    hideButtonByPermission('#newTravelBtn', 'leaves.createTravel');
    hideButtonByPermission('#processPayrollBtn', 'payroll.approve');
    hideButtonByPermission('#payrollExportBtn', 'payroll.export');
    document.querySelectorAll('[data-delete-employee]').forEach(btn => btn.classList.toggle('is-permission-hidden', !canFull('employees.delete')));
    document.querySelectorAll('[data-edit-employee]').forEach(btn => {
      const employeeId = btn.dataset.editEmployee;
      const allowed = canFull('employees.edit') || (canFull('employees.editSelf') && ownsEmployee(employeeId)) || (canFull('employees.viewAll') || ownsEmployee(employeeId));
      btn.classList.toggle('is-permission-hidden', !allowed);
    });
    document.querySelectorAll('[data-leave-action="approved"]').forEach(btn => btn.classList.toggle('is-permission-hidden', !canFull('leaves.approveLeave')));
    document.querySelectorAll('[data-leave-action="rejected"]').forEach(btn => btn.classList.toggle('is-permission-hidden', !canFull('leaves.rejectLeave')));
    document.querySelectorAll('[data-leave-return]').forEach(btn => btn.classList.toggle('is-permission-hidden', !canFull('leaves.resume')));
    document.querySelectorAll('[data-travel-approve], #approveTravelOnlyBtn, #approveTravelWithCommissionBtn').forEach(btn => btn.classList.toggle('is-permission-hidden', !canFull('leaves.approveTravel')));
    document.querySelectorAll('[data-travel-reject]').forEach(btn => btn.classList.toggle('is-permission-hidden', !canFull('leaves.rejectTravel')));
    document.querySelectorAll('[data-travel-resume], #travelResumeForm button[type="submit"]').forEach(btn => btn.classList.toggle('is-permission-hidden', !canFull('leaves.resume')));
    document.querySelectorAll('[data-print-commission], #previewClearanceBtn, #issueClearanceBtn, #printClearancePreviewBtn').forEach(btn => btn.classList.toggle('is-permission-hidden', !canFull('payroll.printClearance')));
    document.querySelectorAll('[data-delete-absence]').forEach(btn => btn.classList.toggle('is-permission-hidden', !canFull('attendance.deleteAbsence')));
    document.querySelectorAll('[data-settings-section="permissions"]').forEach(btn => btn.classList.toggle('is-permission-hidden', !canFull('settings.permissionsSecurity')));
    document.querySelectorAll('[data-settings-section="work"]').forEach(btn => btn.classList.toggle('is-permission-hidden', !canFull('settings.work')));
    document.querySelectorAll('[data-settings-section="absence"]').forEach(btn => btn.classList.toggle('is-permission-hidden', !canFull('settings.absencePolicy')));
    document.querySelectorAll('[data-settings-section="minuteSettings"]').forEach(btn => btn.classList.toggle('is-permission-hidden', !canFull('settings.minutes')));
  }
  const oldApplyRolePermissionsFull = applyRolePermissions;
  applyRolePermissions = function(){
    try { oldApplyRolePermissionsFull(); } catch (_) {}
    document.querySelectorAll('.nav-item[data-view]').forEach(btn => btn.classList.toggle('is-permission-hidden', !roleCanOpen(btn.dataset.view)));
    document.querySelectorAll('[data-go-view]').forEach(el => { const view = el.dataset.goView; if (view && pageMeta[view]) el.classList.toggle('is-permission-hidden', !roleCanOpen(view)); });
    if (!roleIsAdmin()) {
      document.querySelector('#statsGrid')?.classList.toggle('is-permission-hidden', !canFull('dashboard.stats'));
      document.querySelector('[data-go-view="employees"]')?.classList.toggle('is-permission-hidden', !canFull('dashboard.cardEmployees'));
      document.querySelector('[data-go-view="attendance"]')?.classList.toggle('is-permission-hidden', !canFull('dashboard.cardAttendance'));
      document.querySelector('[data-go-view="leaves"]')?.classList.toggle('is-permission-hidden', !canFull('dashboard.cardLeaves') && !canFull('dashboard.reviewShortcut'));
      document.querySelector('[data-go-view="payroll"]')?.classList.toggle('is-permission-hidden', !canFull('dashboard.cardPayroll'));
      document.querySelector('.leave-panel')?.classList.toggle('is-permission-hidden', !canFull('dashboard.reviewRequests'));
      document.querySelector('.travelers-dashboard-panel, .attendance-panel')?.classList.toggle('is-permission-hidden', !canFull('dashboard.travelers'));
      document.querySelector('.recent-panel')?.classList.toggle('is-permission-hidden', !canFull('dashboard.recentEmployees'));
    }
    applyButtonPermissions();
  };

  const oldFilteredEmployeesFull = filteredEmployees;
  filteredEmployees = function(){
    const rows = oldFilteredEmployeesFull();
    if (roleIsAdmin() || canFull('employees.viewAll')) return rows;
    if (canFull('employees.viewSelf')) return rows.filter(e => ownsEmployee(e.id));
    return [];
  };
  const oldAttendanceRowsForDateFull = attendanceRowsForDate;
  attendanceRowsForDate = function(dateString = selectedAttendanceDate){
    const rows = oldAttendanceRowsForDateFull(dateString);
    if (roleIsAdmin() || canFull('attendance.viewAll')) return rows;
    if (canFull('attendance.viewSelf')) return rows.filter(row => ownsEmployee(row.employee.id));
    return [];
  };
  const oldRenderAbsenceRecordsFull = renderAbsenceRecords;
  renderAbsenceRecords = function(){
    if (roleIsAdmin() || canFull('attendance.viewAll')) return oldRenderAbsenceRecordsFull();
    const original = attendanceExceptions;
    try {
      attendanceExceptions = Array.isArray(attendanceExceptions) ? attendanceExceptions.filter(record => ownsEmployee(record.employeeId)) : [];
      oldRenderAbsenceRecordsFull();
    } finally { attendanceExceptions = original; }
  };
  const oldRenderLeavesFull = renderLeaves;
  renderLeaves = function(){
    if (roleIsAdmin() || canFull('leaves.viewAll')) { oldRenderLeavesFull(); applyButtonPermissions(); return; }
    const original = leaves;
    try {
      leaves = Array.isArray(leaves) && canFull('leaves.viewOwn') ? leaves.filter(l => ownsEmployee(l.employeeId)) : [];
      oldRenderLeavesFull();
    } finally { leaves = original; }
    applyButtonPermissions();
  };
  const oldRenderPayrollFull = renderPayroll;
  renderPayroll = function(){
    if (roleIsAdmin() || canFull('payroll.viewAll')) { oldRenderPayrollFull(); applyButtonPermissions(); return; }
    const original = employees;
    try {
      employees = Array.isArray(employees) && canFull('payroll.viewSelf') ? employees.filter(e => ownsEmployee(e.id)) : [];
      oldRenderPayrollFull();
    } finally { employees = original; }
    applyButtonPermissions();
  };
  const oldRenderDashboardFull = renderDashboard;
  renderDashboard = function(){
    oldRenderDashboardFull();
    if (!roleIsAdmin()) {
      const list = document.querySelector('#leavePreviewList');
      if (list && canFull('dashboard.reviewRequests')) {
        let visibleLeaves = (Array.isArray(leaves) ? leaves : []).filter(l => l.status === 'pending');
        if (!canFull('dashboard.reviewAll') && !canFull('leaves.viewAll')) visibleLeaves = visibleLeaves.filter(l => ownsEmployee(l.employeeId));
        list.innerHTML = visibleLeaves.length ? visibleLeaves.slice(0, 5).map(leave => {
          const employee = getEmployee(leave.employeeId); if (!employee) return '';
          const actions = canFull('dashboard.reviewActions') ? `<div class="mini-actions"><button data-leave-action="approved" data-leave-id="${leave.id}" title="موافقة">${iconSvg('check')}</button><button data-leave-action="rejected" data-leave-id="${leave.id}" title="رفض">${iconSvg('x')}</button></div>` : '';
          return `<div class="leave-preview-item">${employeeAvatar(employee)}<div class="leave-preview-info"><button type="button" class="employee-name-link" data-quick-view="${employee.id}">${escapeHtml(employee.name)}</button><span>${escapeHtml(leave.type)} · ${arabicNumber(leave.days)} أيام</span></div>${actions}</div>`;
        }).join('') : '<div class="empty-state"><strong>لا توجد طلبات متاحة</strong></div>';
      }
      document.querySelector('.leave-panel')?.classList.toggle('is-permission-hidden', !canFull('dashboard.reviewRequests'));
      document.querySelector('.travelers-dashboard-panel, .attendance-panel')?.classList.toggle('is-permission-hidden', !canFull('dashboard.travelers'));
      if (!canFull('dashboard.reviewShortcut')) document.querySelector('.banner-action[data-go-view="leaves"]')?.classList.add('is-permission-hidden');
    }
    applyRolePermissions();
  ...
  document.addEventListener('click', function(event){
    ...
    const target = event.target;
    const checks = [
      ['#quickAddBtn, .add-employee-btn, [data-open-employee-modal="new"]', 'employees.create', 'إضافة الموظفين غير مسموحة'],
      ['#exportBtn', 'employees.export', 'تصدير الموظفين غير مسموح'],
      ['#newAbsenceBtn, #dashboardAbsenceBtn', 'attendance.registerAbsence', 'تسجيل الغياب غير مسموح'],
      ['#attendanceExportBtn', 'attendance.export', 'تصدير الحضور غير مسموح'],
      ['#newLeaveBtn', 'leaves.createLeave', 'إنشاء الإجازة غير مسموح'],
      ['#newTravelBtn', 'leaves.createTravel', 'إنشاء السفر غير مسموح'],
      ['#processPayrollBtn', 'payroll.approve', 'اعتماد الرواتب غير مسموح'],
      ['#payrollExportBtn', 'payroll.export', 'تصدير الرواتب غير مسموح'],
      ['#previewClearanceBtn, #issueClearanceBtn, #printClearancePreviewBtn, [data-print-commission]', 'payroll.printClearance', 'طباعة المخالصة غير مسموحة'],
      ['[data-delete-employee]', 'employees.delete', 'حذف الموظفين غير مسموح'],
      ['[data-delete-absence]', 'attendance.deleteAbsence', 'حذف الغياب غير مسموح'],
      ['[data-travel-approve], #approveTravelOnlyBtn, #approveTravelWithCommissionBtn', 'leaves.approveTravel', 'اعتماد السفر غير مسموح'],
      ['[data-travel-reject]', 'leaves.rejectTravel', 'رفض السفر غير مسموح'],
      ['[data-travel-resume], #travelResumeForm button[type="submit"]', 'leaves.resume', 'تسجيل المباشرة غير مسموح']
    ];
    for (const [selector, permission, message] of checks) {
      if (target.closest(selector) && !canFull(permission)) { event.preventDefault(); event.stopImmediatePropagation(); deny(message); return; }
    }
    const leaveAction = target.closest('[data-leave-action]');
    if (leaveAction) {
      const status = leaveAction.dataset.leaveAction;
      const required = status === 'approved' ? 'leaves.approveLeave' : 'leaves.rejectLeave';
      if (!canFull(required)) { event.preventDefault(); event.stopImmediatePropagation(); deny('اعتماد أو رفض الإجازات غير مسموح'); return; }
    }
    const leaveReturn = target.closest('[data-leave-return]');
    if (leaveReturn && !canFull('leaves.resume')) { event.preventDefault(); event.stopImmediatePropagation(); deny('تسجيل المباشرة غير مسموح'); return; }
    const edit = target.closest('[data-edit-employee]');
    if (edit) {
      const id = edit.dataset.editEmployee;
      const allowed = canFull('employees.edit') || (canFull('employees.editSelf') && ownsEmployee(id)) || (canFull('employees.viewSelf') && ownsEmployee(id)) || canFull('employees.viewAll');
      if (!allowed) { event.preventDefault(); event.stopImmediatePropagation(); deny('عرض أو تعديل هذا الموظف غير مسموح'); return; }
    }
  }, true);

  // Apply once after page boot and after common renders.
  setTimeout(() => { try { applyRolePermissions(); } catch (_) {} }, 300);
})();
